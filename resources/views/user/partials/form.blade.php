    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" id="title" name="title" class="form-control"
                   value="{{ old('title', $user->title ?? NULL) }}">
            @error('title')
        ...
        <div class="mb-3">
            ...
            <input type="text" id="phone" name="phone" class="form-control" value="{{ old('phone', $user?->phone ?? null) }}">
            @error('phone')
            <span class="form-text text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" id="phone-alt" name="phone_alt" class="form-control"
                   value="{{ old('phone_alt', $user?->phone_alt ?? null) }}">
            @error('phone_alt')
            <span class="form-text text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <select type="text" id="gender" name="gender" class="form-control">
                <option value=""></option>
                <option value="male" {{ old('gender', $user->gender ?? null) === 'male' ? 'selected' : '' }}>
                    {{__('Male')}}
                </option>
                <option value="female" {{ old('gender', $user->gender ?? null) === 'female' ? 'selected' : '' }}>
                    {{__('Female')}}
                </option>
                <option value="other" {{ old('gender', $user->gender ?? null) === 'other' ? 'selected' : '' }}>
                    {{__('Other')}}
                </option>
            </select>
            @error('gender')
    ...
    <div class="col-md-6">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="street-additional" name="street_additional" class="form-control"
                   value="{{ old('street_additional', $user->street_additional ?? null) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="city" name="city" class="form-control" value="{{ old('city', $user->city ?? null) }}">
            @error('city')
            <span class="form-text text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" id="postcode" name="postcode" class="form-control"
                   value="{{ old('postcode', $user->postcode ?? null) }}">
            @error('postcode')
            <span class="form-text text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="date" id="birthdate" name="birthdate" class="form-control"
                   value="{{ old('birthdate', $user->birthdate ?? null) }}"
                   max="{{date('Y-m-d')}}">
            @error('birthdate')
            <span class="form-text text-danger">{{ $message }}</span>
            @enderror
